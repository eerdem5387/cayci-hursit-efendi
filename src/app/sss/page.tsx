...
export default function FAQPage() {
  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-10 md:px-6">
      <h1 className="mb-8 text-3xl font-extrabold text-emerald-900">Sizden Gelen Sorular</h1>
      ...
      <div className="grid items-start gap-8 md:grid-cols-2">
        <div className="space-y-3">
          {faqs.map((f, i) => {
            ...
            return (
              <div key={f.q} className="rounded-2xl border border-emerald-100 bg-white">
                <button
